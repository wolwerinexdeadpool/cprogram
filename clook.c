...
int calculateTotalHeadMovement_CLOOK(int requests[], int numRequests, int headPosition, int direction);
...
// Function to calculate total head movement for C-LOOK
int calculateTotalHeadMovement_CLOOK(int requests[], int numRequests, int headPosition, int direction) {
    int totalMovement = 0;
...
int main() {
    ...
    int totalHeadMovement = calculateTotalHeadMovement_CLOOK(requests, numRequests, headPosition, direction);
